...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-bg-base)] p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-primary-300/30 blur-[100px]" />
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-2xl z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-text-muted)]">Sign in to manage your team's tasks</p>
        </div>
